...
std::string sub(const std::string &string, re2::RE2 &pattern, const std::string repl, size_t offset=0);

std::string sub(const std::string &string, re2::RE2 &pattern, std::function<std::string(MatchObject&)> repl, size_t offset=0);
